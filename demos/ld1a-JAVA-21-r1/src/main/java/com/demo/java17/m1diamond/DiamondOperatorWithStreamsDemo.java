...
// The java.time was introduced in Java.
// The LocalDateTime class is used to represent date and time without a time zone.
import java.time.LocalDateTime;
// The ChronoUnit class is used to perform date and time calculations.
...
// The Collectors class provides various utility methods for working with streams, including grouping and collecting elements.
// The Collections class provides utility methods for working with collections, such as lists and sets.
// Collectors were introduced in Java 8 where as Collections have been part of Java since version 1.2
